    ...
    <section className="relative min-h-[88vh] flex items-center overflow-hidden">
      ...
      <div className="relative max-w-6xl mx-auto px-6 py-24 w-full grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        <div className="space-y-8">
          ...
          <div
            style={{
              animation: "fade-up 0.6s cubic-bezier(0.22, 1, 0.36, 1) 100ms both",
            }}
          >
          ...
          <div
            ...
            style={{
              animation: "fade-up 0.6s cubic-bezier(0.22, 1, 0.36, 1) 220ms both",
            }}
          >
          ...
          <p
            ...
            style={{
              animation: "fade-up 0.6s cubic-bezier(0.22, 1, 0.36, 1) 320ms both",
            }}
          >
            Free to use &middot; No credit card required &middot; Works with any
            team
          </p>
        </div>
